...
| config.mk.rustc_codegen_gcc.sample | rustc_codegen_gcc git | 4.4.0 | 2.41 | 8.5.0 | 2.41 | latest gcc version with rustc_codegen_gcc-enabled libgccjit from git<br />for latest Rust support via rustc_codegen_gcc<br />builds with caveats, see sample file for more info |
